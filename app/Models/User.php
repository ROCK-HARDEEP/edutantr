...
class User extends Authenticatable implements JWTSubject, MustVerifyEmail
{
    ...
    public function salesTeamMember(): HasOne
    {
        return $this->hasOne(SalesTeamMember::class);
    }
    ...
    public function salesCounselor(): BelongsTo
    {
        return $this->belongsTo(SalesTeamMember::class, 'sales_team_member_id');
    }
