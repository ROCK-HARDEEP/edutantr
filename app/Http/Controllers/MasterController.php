    ...
    public function index(Request $request)
    {
        ...
        return $this->json('Master info found', [
            'master' => [
                ...
                'publish_plan' => $organization ? false : ($setting?->publish_plan ?? false),
                ...
                'hero_thumbnail' => $setting?->heroPath ?? asset('assets/website/banner-hero.png'),
                'about_thumbnail' => $setting?->aboutPath ?? asset('assets/images/website/about-us.png'),
                'footer_bg_thumbnail' => $setting?->footerBGPath ?? asset('assets/website/footer-bg-2.png'),
