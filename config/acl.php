...
return [
    'permissions' => [
        ...
        'sales_team' => ['index', 'create', 'store', 'edit', 'update', 'destroy'],
        'revenue_leaderboard' => ['index', 'data'],
        ...
        'job_category' => ['index', 'create', 'store', 'edit', 'update', 'destroy'],
        'job_post' => ['index', 'create', 'store', 'edit', 'update', 'destroy', 'close'],
        'job_application' => ['index', 'show', 'update'],
    ],
];
