...
<body
    style="background-image: url({{ $certificate?->framePath ?? asset('assets/certificate/themeone.png') }}); background-size: cover;">
            ...
            <div class="certificate-header">
                ...
                <div class="space-between" style="display: table; padding: 8px 0; width: 100%;">
                    <div style="display: table-cell; vertical-align: middle;">
                        <img src="{{ asset('assets/certificate/line.svg') }}" alt="" style="width: 150px; margin-top:12px">
                    </div>
                    <div style="display: table-cell; vertical-align: middle;">
