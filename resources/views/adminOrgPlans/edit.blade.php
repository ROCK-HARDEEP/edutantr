...
@section('title', $app_setting['name'] . ' | ' . __('Update Organization Plan'))

@section('header-title')
    <h3 class="title">{{ __('Update Organization Plan') }}</h3>
@endsection
...
@section('content')
    ...
    <div class="app-main-outer">
        <div class="app-main-inner">
            ...
            <form action="{{ route('admin.organizations.plan.update', $plan->id) }}" method="POST">
                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <input id="planTitle" type="text" name="title" class="form-control"
                                            ...
                                            placeholder="{{ __('Enter Plan Title') }}" value="{{ $plan->title }}">
                                        <div class="mt-2">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <select name="plan_type" class="form-control" id="discountType">
                                            ...
                                            <option value="monthly" {{ $plan->plan_type == 'monthly' ? 'selected' : '' }}>
                                                {{ __('Monthly') }}</option>
                                            <option value="yearly" {{ $plan->plan_type == 'yearly' ? 'selected' : '' }}>
                                                {{ __('Yearly') }}
                                            </option>
                                        </select>
                                        @error('plan_type')
