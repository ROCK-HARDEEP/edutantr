...
@section('header-title')
    <h3 class="title">{{ __('Pre-defined Notification List') }}</h3>
@endsection
                                            ...
                                            <tr class="fade-in-row">
                                                ...
                                                <td class="tableAction">
                                                    ...
                                                    <a class="drop-item tooltip-custom"
                                                        href="{{ route('notification.edit', $notification->id) }}" target="_blank">
                                                        <i class="fa-solid fa-pen-to-square me-1 text-warning"></i>
                                                        <span class="tooltip-text">{{ __('Edit Notification') }}</span>
                                                    </a>
                                                </td>
                                            </tr>
                                        @endforeach
