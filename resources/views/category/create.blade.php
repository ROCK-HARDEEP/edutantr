...
@section('header-title')
    <h3 class="title">{{ __('New Category') }}</h3>
@endsection
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input name="color" type="color" class="form-control form-control-color"
                                                id="colorInput" value="#306c3c" title="{{ __('Choose your color') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row g-4">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="d-flex flex-wrap gap-2 mt-2">
                                            <!-- Hidden Input -->
                                            <input type="hidden" name="color" id="colorInput" value="#3E1E68">
                                        ...
                                        <div class="mt-3 d-flex align-items-center">
                                            ...
                                            <div id="colorPreview"
                                                ...
                                                style="width: 40px; height: 40px; background: #3E1E68;">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="upload-box rounded-5 text-center p-4 shadow-sm hover-glow mt-3"
                                            ...
                                            <div class="mb-3">
                                                <img id="imagePreview" src="https://placehold.co/150x150" alt="Preview"
