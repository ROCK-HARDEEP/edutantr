...
@section('header-title')
    <h3 class="title">{{ __('Create a New Course') }}</h3>
@endsection
                            ...
                            <div class="card-body">
                                <div class="row align-items-start">
                                    <div class="col-md-6 border-end">
                                        <div class="mb-3">
                                            <img id="courseImagePreview" src="https://placehold.co/350x200" class="w-100"
                                                style="height: 380px; border-radius:1rem; object-fit: cover">
                                        </div>
                                        <div>
                                                ...
                                                <div class="border rounded-3 p-3 bg-light">
                                                    <div class="form-check mb-3">
                                                        <input id="preCourseEnabled" name="pre_course_enabled"
                                                            ...
                                                            {{ old('pre_course_enabled') ? 'checked' : '' }}
                                                    ...
                                                    <div id="preCourseFields" style="display: none;">
                                                        <div class="row">
                                                            <div class="col-md-6 mb-3">
                                                                ...
                                                                <input type="text" class="form-control" id="preCoursePrice"
                                                                    name="pre_course_price" value="{{ old('pre_course_price') }}"
                                                            ...
                                                            <div class="col-md-12">
                                                                ...
                                                                <textarea class="form-control" id="preCourseDescription"
                                                                    ...
                                                                    placeholder="{{ __('Short description for pre-course registration') }}">{{ old('pre_course_description') }}</textarea>
