...
@section('header-title')
    <h3 class="title">{{ __('Course Overview') }}</h3>
@endsection
                ...
                <div class="row">
                    ...
                    <div class="col-lg-1">
                        <div class="d-flex flex-column align-items-end gap-3">
                            <a class="drop-item tooltip-custom p-0" href="{{ route('course.edit', $course->id) }}"
                                target="_blank">
                                <i class="fa-solid fa-pen-to-square me-1 text-primary fs-2"></i>
