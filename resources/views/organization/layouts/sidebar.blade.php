            ...
            <ul>
                ...
                @if ($app_setting['organization']?->domain == request()->getSchemeAndHttpHost())
                    ...
                    @canany(['job_category.index', 'job_post.index', 'job_application.index'])
                        <li class="tp-dropdown__menu-item mb-7 {{ request()->routeIs('job-category.*', 'job-post.*', 'job-application.*') ? 'open' : '' }}">
                            <a href="#" class="tp-dropdown-toggle">
                                <div class="tp-sidebar-menu-left d-flex align-items-center">
                                    <i class="fa-solid fa-briefcase menu-icon" style="width:20px;text-align:center"></i>
                                    <span class="tp-sidebar-menu-list-title ml-7">{{ __('Career Portal') }}</span>
                                </div>
                                <i class="far fa-angle-right dropdown-icon"></i>
                            </a>
                            <ul class="tp-dropdown__menu tpfadeInLeft-2">
                                @can('job_category.index')
                                    <li class="{{ request()->routeIs('job-category.*') ? 'active' : '' }}">
                                        <a href="{{ route('job-category.index') }}">
                                            <div class="tp-sidebar-menu-left d-flex align-items-center">
                                                <span class="tp-sidebar-menu-list-title ml-7">{{ __('Job Categories') }}</span>
                                            </div>
                                        </a>
                                    </li>
                                @endcan
                                @can('job_post.index')
                                    <li class="{{ request()->routeIs('job-post.*') ? 'active' : '' }}">
                                        <a href="{{ route('job-post.index') }}">
                                            <div class="tp-sidebar-menu-left d-flex align-items-center">
                                                <span class="tp-sidebar-menu-list-title ml-7">{{ __('Job Posts') }}</span>
                                            </div>
                                        </a>
                                    </li>
                                @endcan
                                @can('job_application.index')
                                    <li class="{{ request()->routeIs('job-application.*') ? 'active' : '' }}">
                                        <a href="{{ route('job-application.index') }}">
                                            <div class="tp-sidebar-menu-left d-flex align-items-center">
                                                <span class="tp-sidebar-menu-list-title ml-7">{{ __('Applications') }}</span>
                                            </div>
                                        </a>
                                    </li>
                                @endcan
