...
@section('title', $app_setting['name'] . ' | ' . __('Quiz Create'))

@section('header-title')
    <h3 class="title">{{ __('Create a New Quiz') }}</h3>
@endsection
                                            ...
                                            <select id="chapterInput" class="form-select form-control" name="chapter_id">
                                                ...
                                                @foreach ($chapters as $chapter)
                                                    <option value="{{ $chapter->id }}"
                                                        {{ (string) old('chapter_id') === (string) $chapter->id ? 'selected' : '' }}>
                                                        {{ $chapter->title }}
                                                    </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="number" min="1" name="duration_per_question"
                                                ...
                                                placeholder="{{ __('Enter duration per question') }}">
                                        ...
                                        <div id="questionsWrapper">
                                            <div id="question1" class="row border border-primary rounded-3 p-3 mb-3">
                                                ...
                                                <div class="col-6">
                                                    <div class="mb-3">
                                                        <label for="textInput"
                                                            class="form-label">{{ __('Question Title') }}
                                                            ({{ __('can add multiple choice') }}.)</label>
...
@push('scripts')
    <script>
        ...
        function updateChapterOptions(courseId, selectedChapterId = '') {
