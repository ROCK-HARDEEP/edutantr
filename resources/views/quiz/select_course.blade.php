...
@section('title', $app_setting['name'] . ' | ' . __('Select Quiz Course'))

@section('header-title')
    <h3 class="title">{{ __('Select a course to view quizzes') }}</h3>
@endsection
                        ...
                        <div class="card-body">
                            <div class="d-flex flex-wrap gap-3 justify-content-end mb-4 align-items-center">
                                ...
                                <div class="d-flex flex-column justify-content-end align-items-end contain-width gap-3">
                                    <form action="{{ route('quiz.select_course') }}" method="GET" class="w-100">
                                            ...
                                            <tr class="fade-in-row">
                                                <td>
                                                    <div class="d-flex align-items-center justify-content-start">
                                                        <img src="{{ $course?->mediaPath }}" alt="image" width="100%"
                                                            height="40" style="border-radius: 4px; object-fit: cover">
                                                    </div>
                                                </td>
                                                ...
                                                <td class="tableId">{{ $course->title }}</td>
                                                <td class="tableId">
                                                    @php
                                                        $price =
                                                ...
                                                <td style="min-width: 120px;">
                                                    <a class="action-icon btn-outline-primary d-flex justify-content-center p-2 rounded-3"
                                                        ...
                                                        data-bs-custom-class="custom-tooltip" data-bs-title="View Quizzes"
