...
<body>
        ...
        <div class="container mx-auto my-auto">
            <div class="main-card card h-100 d-flex flex-column overflow-hidden shadow rounded-4">
                <div class="row">
                        ...
                        <div class="px-4 py-5 m-0">
                            ...
                            <form action="{{ route('instructor.authenticate') }}" method="POST">
                                ...
                                <div class="form-outline mb-4">
                                    <div class="form-check">
                                        <input class="form-check-input" type="checkbox" value=""
                                            id="instructor_agreement" required onchange="myAgreement(event)">
                                        <label class="form-check-label" for="instructor_agreement"
                                ...
                                <div class="text-start">
                                    <button type="submit" id="insLoginBtn"
                                        class="btn btn-primary btn-sm rounded-2 fw-bold py-3 px-4 mb-3" disabled
                                        onclick="loadder()">
                    ...
                    <div class="col-lg-6">
                        <img src="{{ asset('assets/images/auth/ins-register.jpg') }}" alt="auth-login"
    ...
    <script>
        ...
        const myAgreement = (e) => {
            if (e.target.checked) {
                document.getElementById('insLoginBtn').disabled = false;
            } else {
                document.getElementById('insLoginBtn').disabled = true;
            }
        }
