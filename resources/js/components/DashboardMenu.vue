<template>
    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
        ...
        <router-link :to="{ name: 'myJobApplications' }" class="nav-link">
            <i class="bi bi-briefcase me-3"></i>{{ $t('Job Applications') }}
        </router-link>
    </div>
    <div class="nav flex-column nav-pills">
        <button type="button" @click="logout()" class="nav-link" style="color: #FF0B55;">
